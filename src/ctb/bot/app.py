...
BOT_COMMANDS: Final[tuple[BotCommand, ...]] = (
    ...
    BotCommand(command="board", description="Workspaces, then sessions"),
    ...
    BotCommand(command="fork", description="New session, new topic"),
    BotCommand(command="notify", description="Topic alerts"),
    BotCommand(command="done", description="Archive this task"),
